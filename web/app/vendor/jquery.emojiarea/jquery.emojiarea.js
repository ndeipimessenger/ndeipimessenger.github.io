 ...
 */
 ...
 /**
 * This file also contains some modifications by Ndeipi Messenger in order to add custom scrollbars to EmojiMenu
...
(function($, window, document) {
	...
	/*! MODIFICATION START
		 This function was added by Ndeipi Messenger to save recent used emojis.
		 */
	...
	EmojiArea_Plain.prototype.insert = function(emoji) {
		...
		/* MODIFICATION: Following line was added by Ndeipi Messenger, in order to save recent emojis */
	...
	var EmojiArea_WYSIWYG = function($textarea, options) {
		...
		/*! MODIFICATION START
			Following code was modified by Ndeipi Messenger, in order to improve rich text paste
		*/
		...
		/* MODIFICATION: Following line was modified by Ndeipi Messenger, in order to improve emoji insert behaviour */
	...
	EmojiArea_WYSIWYG.prototype.insert = function(emoji) {
		...
		/*! MODIFICATION START
			Following code was modified by Ndeipi Messenger, in order to improve selection handling
		*/
		var self = this;
		setTimeout(function () {
			self.selection = util.saveSelection();
	...
	var EmojiMenu = function() {
		...
		/*! MODIFICATION START
			Following code was modified by Ndeipi Messenger, in order to add scrollbars and tail to EmojiMenu
		...
		*/
		...
		/*! MODIFICATION: Following 3 lines were added by Ndeipi Messenger, in order to add scrollbars to EmojiMenu  */
		if (!Config.Mobile) {
		...
		/*! MODIFICATION: Following 3 lines were added by Ndeipi Messenger, in order to hide menu on message submit with keyboard */
		...
		$body.on('mouseup', function(e) {
			/*! MODIFICATION START
				Following code was added by Ndeipi Messenger, in order to prevent close on click on EmojiMenu scrollbar
			*/
			e = e.originalEvent || e;
		...
		this.$menu.on('click', 'a', function(e) {
			...
			window.setTimeout(function() {
				...
				/*! MODIFICATION START
					Following code was modified by Ndeipi Messenger, in order to close only on ctrl-, alt- emoji select
				*/
	...
	/* MODIFICATION:
		...
		Also function was modified by Ndeipi Messenger in order to display recent emojis from localStorage
	*/
	EmojiMenu.prototype.load = function(category) {
		...
		/*! MODIFICATION: Following function was added by Ndeipi Messenger, in order to add scrollbars to EmojiMenu */
	...
	EmojiMenu.prototype.show = function(emojiarea) {
		/* MODIFICATION: Following line was modified by Ndeipi Messenger, in order to improve EmojiMenu behaviour */
		...
		this.reposition();
		this.$menu.show();
		/* MODIFICATION: Following 3 lines were added by Ndeipi Messenger, in order to update EmojiMenu contents */
