...
angular.module('myApp.controllers', ['myApp.i18n'])
  ...
  .controller('AppLoginController', function ($scope, $rootScope, $location, $timeout, $modal, $modalStack, MtpApiManager, ErrorService, NotificationsManager, ChangelogNotifyService, IdleManager, LayoutSwitchService, NdeipiMeWebService, _) {
    ...
    MtpApiManager.getUserID().then(function (id) {
      ...
      NdeipiMeWebService.setAuthorized(false);
    });
